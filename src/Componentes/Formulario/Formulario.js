        ...
        <div className="formulario">
            <div className="log-form">
                <form onSubmit={handleSubmit} >
                    ...
                    <br />
                    <FontAwesomeIcon className="fa-exclamationCircle" icon={faExclamationCircle} />  <label className="labelForm" id="date">Fecha de nacimiento             <input className="inputForm" onChange={handleChange} type="date" name="date" required /></label>
                    <br />
