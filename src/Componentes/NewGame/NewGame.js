...
const NewGame = () => {
    ...
    const statePorcentage = {
        uploadValues: 0
    }

    const [value, setvalue] = useState(statePorcentage);
    ...
    const registro = React.useCallback(async () => {
        try { 
            ...
            const newRef = storageRef.ref('images/'+ formState.name).child(Imagen.name); // nombre del archivo
    ...
    return (
        <div className="formulario">
                <form onSubmit={handleSubmit(onSubmit)} id="formulario" >
                    ...
                    <label className="labelForm">Imagen puta
